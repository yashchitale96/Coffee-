    ...
    <AnimatePresence>
      {!isComplete && (
        <motion.div
          ...
          className="fixed inset-0 z-50 bg-gradient-to-br from-amber-900 via-orange-900 to-red-900 flex items-center justify-center px-4"
        >
          {/* Background Pattern */}
          ...
          <div className="text-center text-white z-10 w-full max-w-md mx-auto">
            {/* Animated Logo */}
            <motion.div
            ...
            >
              ...
              >
                <Coffee className="w-12 h-12 sm:w-16 sm:h-16 text-amber-300 mr-2 sm:mr-4" />
              </motion.div>
              <motion.div
            ...
            <motion.p
              ...
              className="text-base sm:text-xl text-amber-100 mb-6 sm:mb-8"
            >
            ...
            {[...Array(6)].map((_, i) => (
              <motion.div
                key={i}
                className="absolute w-3 h-3 sm:w-4 sm:h-4 bg-amber-600 rounded-full"
                style={{
                  left: `${15 + i * 12}%`,
                  top: `${25 + (i % 2) * 50}%`,
                }}
